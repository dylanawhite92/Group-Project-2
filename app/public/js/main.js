    ...
    $.get("/api/league_data", function(data) {
      ...
      for (var i = 0; i < data.length; i++) {
        if (num.includes(data[i].player_name)) {
          ...
          $(".player-card").append(
            `Name: ${data[i].player_name} 2018/2019 Salary: $${addCommas(
              currency
            )} 
                Position: ${data[i].player_position} Team Name: ${
              data[i].team_name
            } 
      ...
      for (var i = 0; i < data.length; i++) {
        if (num.includes(data[i].player_name)) {
          ...
          $(".player-card").append(
            `Name: ${
              data[i].player_name
            } 2018/2019 Salary: $${currency} Position: ${
              data[i].player_position
            } Team Name: ${data[i].team_name} Points Per Game: ${data[i].ppg}`
          );
